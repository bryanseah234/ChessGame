class Board:
    ...
    def win(self):
        ...
        pieces_list = [str(pieces) for pieces in self.pieces()]
        if "white king" not in pieces_list:
            self.winner = "black"
        elif "black king" not in pieces_list:
            self.winner = "white"
    ...
    def promotion(self):
        ...
        for coord in black_last_row:
            if str(self.get_piece(coord)) == "white pawn":
                self.remove(coord)
                self.add(coord, Queen("white"))
        for coord in white_last_row:
            if str(self.get_piece(coord)) == "black pawn":
                self.remove(coord)
                self.add(coord, Queen("black"))
...
class Pawn(BasePiece):
    ...
    def pawnfirstmove(self, start: tuple, end: tuple):
